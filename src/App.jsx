...
function App() {
  ...
  return (
    <div className="min-h-screen py-8 px-4 flex flex-col items-center max-w-6xl mx-auto">
      <header className="mb-12 text-center">
        <h1 className="text-5xl md:text-7xl font-bold mb-4 tracking-tight">
          <span className="text-gradient">Ruleta de Sorteo</span>
        </h1>
        <p className="text-slate-400 text-lg">Sorteos rápidos, justos y visualmente increíbles.</p>
      </header>
      ...
      {winner && (
        <WinnerReveal winner={winner} onReset={reset} />
      )}
